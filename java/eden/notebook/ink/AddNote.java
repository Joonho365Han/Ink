...
public class AddNote extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                else if (position == 8) {//User selects image. If user did not decide to select image, then the color index remains the same as before.
                    startActivityForResult(new Intent(Intent.ACTION_PICK,
                            android.provider.MediaStore.Images.Media.INTERNAL_CONTENT_URI),0);
                    return; //Stop here. Do not update colorIndex until user selects photo.
                }
    ...
    private void saveFile(){
        ...
        if (newTitle.length() >= 255){
            ...
            Library.adapter.addNote(newTitle,createdAt,createdAt,0,colorIndex);
